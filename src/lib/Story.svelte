...
{#each story as entry, i}
    <div id={`story-${i+1}`} class="sticky top-0 flex flex-col items-center h-lvh w-full snap-start">
        <div class="flex justify-around items-center w-full grow flex-col md:flex-row">
            ...
            <div class="border-t md:border-l md:border-t-0 border-white/50 mt-8 mx-8 py-4 md:m-8 md:p-6 md:w-1/3 flex flex-col space-around justify-center">
